...
public class Credit_block extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Credit_block frame = new Credit_block();
	...
	public Credit_block() {
		        ...
		        try {
		        	...
		        	if(a==null) {
		        		...
		        		if(rs.next()) {
		        			...
		        			JOptionPane.showMessageDialog(null, "Your credit card status has been changed from active to blocked");
		        		}
		...
		b1 = new JLabel("Block Credit Card");
