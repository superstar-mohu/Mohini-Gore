...
public class Credit_unblock extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Credit_unblock frame = new Credit_unblock();
	...
	public Credit_unblock() {
		...
		b2 = new JLabel("Do you want to unblock ?");
			...
			public void actionPerformed(ActionEvent e) {
		        ...
		        try {
		        	...
		        	if(a==null) {
		        		...
		        		if(rs.next()) {
		        			String a1=rs.getString("credit_status");
		        			String d="Active";
		        			if(a1.equals(d)) {
		        				JOptionPane.showMessageDialog(null, "Your credit card status is already  Active");
		        			}
		        			else {
		        			String sql2="update apply_now set credit_status='"+d+"' where pin='"+c+"'";
		        			c1.s.executeUpdate(sql2);
		        			JOptionPane.showMessageDialog(null, "Your credit card status has been changed from blocked to Active");
		        		}
		        		}
		        		else {
		...
		b1 = new JLabel("Unblock Credit Card");
		b1.setFont(new Font("Times New Roman", Font.BOLD, 25));
		b1.setBounds(519, 63, 236, 29);
		contentPane.add(b1);
