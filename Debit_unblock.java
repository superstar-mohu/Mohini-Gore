...
public class Debit_unblock extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Debit_unblock frame = new Debit_unblock();
	...
	public Debit_unblock() {
			...
			public void actionPerformed(ActionEvent e) {
		        ...
		        try {
		        	...
		        	if(a==null) {
		        		...
		        		if(rs.next()) {
		        			String a1=rs.getString("debit_status");
		        			String d="Active";
		        			if(a1.equals(d)) {
		        				JOptionPane.showMessageDialog(null, "Your Debit card status is already  Active");
		        			}
		        			else {
		        			String sql2="update apply_now set debit_status='"+d+"' where pin='"+c+"'";
		        			c1.s.executeUpdate(sql2);
		        			JOptionPane.showMessageDialog(null, "Your Debit card status has been changed from blocked to Active");
		        		}
		        		}
		        		else {
		...
		b1 = new JLabel("Unblock Debit Card");
